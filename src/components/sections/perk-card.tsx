...
const PRO_FEATURES = [
  "1M API calls, 1,000 requests/min",
  "Unlimited connections and Relay",
  "Full webhooks, 90-day logs",
  "MCP & CLI access, email support",
];

const STEPS = [
  { title: "Create your workspace", body: "Free at app.withone.ai." },
  { title: "Open Settings → Billing", body: "Pick the Pro plan." },
  { title: "Enter the code at checkout", body: "Your first month is $0." },
];
...
export function PerkCard() {
  return (
    <section className="relative mx-auto max-w-[1180px] px-5 py-16 sm:px-8 md:py-20" id="perk">
      <Reveal>
        <div className="relative rounded-surface border border-border-strong bg-surface shadow-lift-lg">
          ...
          <div className="grid gap-10 p-7 sm:p-10 lg:grid-cols-[1.15fr_1fr] lg:gap-14">
            <div>
              ...
              <p className="mt-4 max-w-[48ch] text-15 text-secondary">
                Pro is normally{" "}
                <span className="text-foreground line-through decoration-muted">$199/mo</span>. Use the
                code and your first month is{" "}
              ...
              <p className="mt-3 flex items-start gap-2.5 text-13 text-secondary">
                ...
                <span>
                  <span className="font-medium text-foreground">Win, and it is a free year.</span> Second
                  place gets six months, third gets three.
                </span>
              </p>
              ...
              <div className="mt-7">
                ...
                <p className="mt-3 text-13 text-muted">
                  The month starts at activation. Prize codes go to the winning teams after demos.
                </p>
              </div>
            </div>
